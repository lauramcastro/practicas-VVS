...
//    	Mockito.when(winehouse1.buscar("Amy")).thenCallRealMethod();
//        Mockito.when(winehouse2.buscar("Amy")).thenCallRealMethod();
//    	Mockito.when(otra.buscar("cancion")).thenCallRealMethod();
//    	Mockito.when(coldplay2.buscar("Speed")).thenCallRealMethod();
