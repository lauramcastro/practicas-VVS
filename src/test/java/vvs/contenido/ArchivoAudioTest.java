...
public class ArchivoAudioTest {
    ...
    public void initialize() throws ExcepcionContenido {
        lavigne1 = new ArchivoAudio("Avril Lavigne: Girlfriend",
                "http://servidor/alavigne/bestdamnthing/1", 216, "Punk pop");
        lavigne2 = new ArchivoAudio("Avril Lavigne: I can do better",
                "http://servidor/alavigne/bestdamnthing/2", 197, "Punk pop");
        eminem1 = new ArchivoAudio("Eminem",
                "http://servidor/alavigne/bestdamnthing/1", 216, "Rap");
    }
   ...
   /* @Test
    ...
    public void obtenerListaReproduccionTest() {
        ...
        assertEquals(true,
                resultado.toArray()[0]
                .equals("http://servidor/alavigne/bestdamnthing/1"));
    ...
    public void ObtenerDuracionNegativaTest() throws ExcepcionContenido {
        new ArchivoAudio("Avril Lavigne: I can do better",
                "http://servidor/alavigne/bestdamnthing/2", -197, "Punk pop");
    }
